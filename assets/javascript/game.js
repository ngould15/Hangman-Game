...
var wordsList = ['the_beets', 'bring_out_the_dancing_lobsters', 'catdog', 'move_it_football_head', 'who_loves_orange_soda'];
...
function startGame() {
    ...
    console.log(chosenWord); //We print the solution in the console
...
function checkLetters(letter) {
    ...
    for (var i = 0; i < numBlanks; i++) {
        /*if (letterInWord == "_") {
            var chosenWord = letterInWord.replace(/_/g, " ");
    }*/
